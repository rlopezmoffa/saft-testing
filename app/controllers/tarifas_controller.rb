class TarifasController < ApplicationController
  ...
  def destroy
    @tarifa.destroy
    respond_to do |format|
      format.html { redirect_to tarifas_url, notice: 'Tarifa was successfully destroyed.' }
  ...
  private
    ...
    def tarifa_params
      params.require(:tarifa).permit(:fecha, :valor_ba_diu, :valor_ba_noc, :valor_fi_diu, :valor_fi_noc)
    end
end
