class CreateDatabase < ActiveRecord::Migration
  def self.up
    ActiveRecord::Schema.define(version: 20120402151524) do
      ...
      add_index "categorias_mantenimiento", ["denominacion"], name: "denominacion_UNIQUE", unique: true, using: :btree
      ...
      add_index "proveedores", ["nombre"], name: "UQ__proveedores__6D6238AF", unique: true, using: :btree
      ...
      add_index "rubros_mantenimiento", ["descripcion"], name: "UQ__servicios__703EA55A", unique: true, using: :btree
